...
<?php if ( 'success' === $status ) : ?>
	<div class="form-notice form-notice--success"><?php esc_html_e( 'Merci, votre demande de partenariat a bien ete envoyee.', 'teeoff' ); ?></div>
<?php elseif ( 'error' === $status ) : ?>
	<div class="form-notice form-notice--error"><?php esc_html_e( 'Une erreur est survenue. Merci de verifier les champs obligatoires.', 'teeoff' ); ?></div>
<?php endif; ?>
...
<form class="teeoff-form" method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" enctype="multipart/form-data">
	...
	<div class="form-row form-row--2col">
		...
		<div class="form-field">
			...
			<select id="p_type" name="partnership_type">
				...
				<option value="telecom"><?php esc_html_e( 'Operateur telecom', 'teeoff' ); ?></option>
				<option value="sante"><?php esc_html_e( 'Sante', 'teeoff' ); ?></option>
				<option value="education"><?php esc_html_e( 'Education', 'teeoff' ); ?></option>
	...
	<div class="form-row form-row--2col">
		...
		<div class="form-field"><label for="p_phone"><?php esc_html_e( 'Telephone', 'teeoff' ); ?></label><input type="tel" id="p_phone" name="phone"></div>
	</div>
	...
	<div class="form-field"><label for="p_file"><?php esc_html_e( 'Piece jointe (facultatif — PDF ou Word)', 'teeoff' ); ?></label><input type="file" id="p_file" name="attachment" accept=".pdf,.doc,.docx"></div>
