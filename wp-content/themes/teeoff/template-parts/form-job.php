...
<?php if ( 'success' === $status ) : ?>
	<div class="form-notice form-notice--success"><?php esc_html_e( 'Merci, votre candidature a bien ete envoyee.', 'teeoff' ); ?></div>
...
<form class="teeoff-form" method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" enctype="multipart/form-data">
	...
	<div class="form-row form-row--2col">
		<div class="form-field"><label for="j_name"><?php esc_html_e( 'Nom et prenom', 'teeoff' ); ?> *</label><input type="text" id="j_name" name="name" required></div>
	...
	<div class="form-field"><label for="j_phone"><?php esc_html_e( 'Telephone', 'teeoff' ); ?></label><input type="tel" id="j_phone" name="phone"></div>
